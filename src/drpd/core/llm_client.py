...
class LLMClient(ABC):
    ...
    @abstractmethod
    def call_structured(self, prompt: str, json_schema: Dict[str, Any], **kwargs) -> str:
...
class LiteLLMClient(LLMClient):
    ...
    def call(self, prompt: str, model_name: str = None, temperature: float = None, max_tokens: int = None, **kwargs) -> str:
    ...
    def call_structured(self, prompt: str, json_schema: Dict[str, Any], model_name: str = None, temperature: float = None, max_tokens: int = None, system_message: str = None, **kwargs):
